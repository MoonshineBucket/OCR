...
public class MemorySection implements ConfigurationSection {
    ...
    @Override
    public String[] getStrings(String path, String split) {
        String string = getString(path);
        return string != null ? string.split(split) : new String[0];
    }

    @Override
    public String[] getStrings(String path, String split, String def) {
