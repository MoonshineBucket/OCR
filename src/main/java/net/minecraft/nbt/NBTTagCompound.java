...
public class NBTTagCompound extends NBTBase
{
    ...
    public byte getByte(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 1, classcastexception);
            return 0;
        }
    }
    ...
    public short getShort(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 2, classcastexception);
            return 0;
        }
    }
    ...
    public int getInteger(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 3, classcastexception);
            return 0;
        }
    }
    ...
    public long getLong(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 4, classcastexception);
            return 0;
        }
    }
    ...
    public float getFloat(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 5, classcastexception);
            return 0;
        }
    }
    ...
    public double getDouble(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 6, classcastexception);
            return 0;
        }
    }
    ...
    public String getString(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 8, classcastexception);
            return null;
        }
    }
    ...
    public byte[] getByteArray(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 7, classcastexception);
            return null;
        }
    }
    ...
    public int[] getIntArray(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 11, classcastexception);
            return null;
        }
    }
    ...
    public NBTTagCompound getCompoundTag(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 10, classcastexception);
            return null;
        }
    }
    ...
    public NBTTagList getTagList(String par1Str)
    {
        ...
        {
            createCrashReport(par1Str, 9, classcastexception);
            return null;
        }
    }
     ...
     */
    private void createCrashReport(String par1Str, int par2, ClassCastException par3ClassCastException)
    {
        System.out.printf("Tag type found: %s.%n", NBTBase.NBTTypes[((NBTBase) NBTTagCompound.getTagMap(this).get(par1Str)).getId()]);
        System.out.printf("Tag type expected: %s.%n", NBTBase.NBTTypes[par2]);
        System.out.printf("Tag name: %s.%n", par1Str);

        String tagName;
        if((tagName = getName()) != null && tagName.length() > 0) {
            System.out.printf("Tag parent: %s.%n", tagName);
        }

        par3ClassCastException.printStackTrace();
    }
